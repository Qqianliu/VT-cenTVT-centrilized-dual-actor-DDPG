...
if __name__ == '__main__':
    ...
    with open("simulation1/users_time_rc_u10_SAME.txt", "w") as f:
        for r in users_time:
            f.write(str(r) + '\n')
    with open("simulation1/reward_rc_u10_SAME.txt", "w") as f:
        for cost in reward:
            f.write(str(cost) + '\n')
    with open("simulation1/server_switch_cost_rc_u10_SAME.txt", "w") as f:
